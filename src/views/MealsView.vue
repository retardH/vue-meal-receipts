...
onMounted(() => {
  ...
  console.log(useMealStore.carouselMeals);
})
</script>
...
<template>
  <MainContainer>
    ...
    <div class="flex items-center justify-center mb-12 mx-auto flex-col md:flex-row">
      ...
      <input type="text" placeholder="Search receipts..."
             ...
             class="py-2 px-4 rounded-sm border-stone-950 border-2 border-r-0 bg-stone-100 text-rose-700 placeholder-rose-700 w-auto md:w-64 focus:outline-0 focus:ring-0"/>
