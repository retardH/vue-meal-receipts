...
<template>
  <MainLayout>
    <div class="flex flex-col gap-2 w-full">
      <h4 class="text-2xl md:text-3xl font-semibold tracking-wide uppercase">
        Categories
      </h4>
      <Divider />
      <div
      ...
      >
        ...
        <div class="flex-1 flex flex-col gap-3">
          <h4 class="font-medium text-2xl">{{ c.strCategory }}</h4>
          <p class="text-lg">{{ c.strCategoryDescription }}</p>
          <Button
